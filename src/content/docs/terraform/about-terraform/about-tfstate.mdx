...
<LinkPreview url="https://envader.plus/article/199" />

> その他参考記事
>
> -   <LinkPreview url="https://zenn.dev/nameless_gyoza/articles/terraform-remote-state" type="inline" />
...
<MermaidChart
    ...
    core((コア))
    tf[tf<br>ファイル]
    tfstate[tfstate<br>ファイル]
    provider(プロバイダ)

    %% ************************************ 関連
    tf ---|リソース設定<br>を読み込む| core
    core ---|tfファイルなどの設定から<br>インフラを作成!| provider
    core ---|作成したインフラストラクチャ<br>と対応したリソースの状態<br>を書き込む| tfstate
