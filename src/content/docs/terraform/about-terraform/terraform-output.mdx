...
- <LinkPreview url="https://hitolog.blog/2021/10/17/terraform-module/" type="inline" />
- <LinkPreview url="https://qiita.com/kyntk/items/2cdd38c2438ac257ac4e" type="inline" />
...
```tf
output "出力時の名前" {
    value = インフラ名.リソース名.プロパティ
}
```

value は一つしか定義できないため、出力したい値があれば、再度、同様に出力したい値を記述する
