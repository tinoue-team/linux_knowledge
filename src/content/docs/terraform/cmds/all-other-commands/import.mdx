...
-   <LinkPreview url="https://dev.classmethod.jp/articles/terraform-import-twoway/" type="inline" />
-   <LinkPreview url="https://dev.classmethod.jp/articles/terraform-import-command-and-import-block/" type="inline" />
-   <LinkPreview url="https://cross-black777.hatenablog.com/entry/2017/07/24/235614" type="inline" />
    tf ファイルの import ブロックを利用して、リソースを tfstate にインポートする{" "}
...
#### AWS IAM ユーザーを import

##### 手順

<Steps>

    1. 予め AWS で IAM ユーザーを作成している(今回は Alice という IAM ユーザを用意)
    1. resource を定義
        ```tf
